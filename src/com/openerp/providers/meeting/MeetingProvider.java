...
/**
 * The Class MeetingProvider.
 */
public class MeetingProvider extends OEContentProvider {

	/** The contenturi. */
	public static String CONTENTURI = "com.openerp.providers.note.MeetingProvider";
