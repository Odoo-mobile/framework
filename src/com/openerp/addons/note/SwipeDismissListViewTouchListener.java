...
public class SwipeDismissListViewTouchListener extends BaseFragment implements
	...
	public void startSyncService() {
		mPullAttacher = ((MainActivity) context).getPullToRefreshAttacher();
	...
	public void onResume() {
		super.onResume();
		((MainActivity) context).registerReceiver(syncFinishReceiver,
	...
	public void onPause() {
		super.onPause();
		((MainActivity) context).unregisterReceiver(syncFinishReceiver);
	}
