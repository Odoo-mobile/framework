...
public class OEEditText extends EditText {
	Context mContext = null;

	public OEEditText(Context context) {
		super(context);
		mContext = context;
		setTypeFace("light");
	}

	public OEEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setTypeFace(getTextStyle(attrs));
	}

	public OEEditText(Context context, AttributeSet attrs, int defStyle) {
